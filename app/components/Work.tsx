  ...
  return (
    <div className="">
        <a href={url} className="flex flex-col justify-between group">
            <div data-image-reveal="" className="flex items-center h-full w-auto ">
            <img 
                src={urlImage} 
                loading="lazy" 
            ...
            <div className="flex items-center justify-between w-full h-[50px] overflow-hidden uppercase">
