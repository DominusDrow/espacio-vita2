...
const Button: React.FC<ButtonProps> = ({ label, onClick }) => {
  ...
  return (
    <button onClick={onClick} className="flex items-center gap-3 bg-black rounded-3xl p-2 lg:p-3 group cursor-pointer">
      <div className="line-height-[1em] overflow-hidden">
        <div className="text-nowrap text-[12px] lg:text-[18px] text-white font-medium uppercase">{label}</div>
      </div>
