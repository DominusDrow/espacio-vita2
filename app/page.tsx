...
import image from './public/assets/images/logo/Logo_VITA.png';
import logo from './public/assets/images/logo/EspacioVita_Transp.png';
...
const Page: React.FC = () => {
  return (
    <div className="">
      ...
      <section className="z-20 pt-12 pb-40 bg-[#fcfcfc] p-10">
